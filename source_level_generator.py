...
class SourceMutatedModelGenerators():
    ...
    def __init__(self, model_architecture='FC'):
        ...
        self.utils = utils_model_op.GeneralUtils()
        ...
        self.source_mut_opts = source_level_operators.SourceMutationOperators()
    ...
    def generate_model_by_source_mutation(self, train_dataset, test_dataset, model, mode, verbose=False):
        ...
        if mode == 'DR':
            (mutated_datas, mutated_labels), mutated_model = self.source_mut_opts.DR_mut(train_dataset, model,
                                                                                         mutation_ratio)
        elif mode == 'LE':
            (mutated_datas, mutated_labels), mutated_model = self.source_mut_opts.LE_mut(train_dataset, model,
                                                                                         lower_bound, upper_bound,
                                                                                         mutation_ratio)
        elif mode == 'DM':
            (mutated_datas, mutated_labels), mutated_model = self.source_mut_opts.DM_mut(train_dataset, model,
                                                                                         mutation_ratio)
        elif mode == 'DF':
            (mutated_datas, mutated_labels), mutated_model = self.source_mut_opts.DF_mut(train_dataset, model,
                                                                                         mutation_ratio)
        elif mode == 'NP':
            (mutated_datas, mutated_labels), mutated_model = self.source_mut_opts.NP_mut(train_dataset, model,
                                                                                         mutation_ratio, STD=STD)
        elif mode == 'LR':
            (mutated_datas, mutated_labels), mutated_model = self.source_mut_opts.LR_mut(train_dataset, model,
                                                                                         mutated_layer_indices=mutated_layer_indices)
        elif mode == 'LAs':
            (mutated_datas, mutated_labels), mutated_model = self.source_mut_opts.LAs_mut(train_dataset, model,
                                                                                          mutated_layer_indices=mutated_layer_indices)
        elif mode == 'AFRs':
            (mutated_datas, mutated_labels), mutated_model = self.source_mut_opts.AFRs_mut(train_dataset, model,
                                                                                           mutated_layer_indices=mutated_layer_indices)
        else:
            pass

        mutated_model = self.network.compile_model(mutated_model)
        trained_mutated_model = self.network.train_model(mutated_model, mutated_datas, mutated_labels,
        ...
        if verbose:
            ...
            self.utils.print_messages_SMO(mode, train_datas=train_datas, train_labels=train_labels,
                                          mutated_datas=mutated_datas, mutated_labels=mutated_labels,
                                          model=trained_model, mutated_model=trained_mutated_model,
