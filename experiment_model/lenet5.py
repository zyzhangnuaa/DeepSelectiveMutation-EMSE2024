...
def main(model_local):
    ...
    if not os.path.exists(model_local):
        ...
        nb_epoch = 10
        model = Sequential()
        model.add(Convolution2D(6, kernel_size, activation='relu', padding='same', name='block1_conv1', input_shape=input_shape))
        ...
        print('lenet5 test loaded')


if __name__ == '__main__':
    main('../original_model/lenet5_original.h5')
