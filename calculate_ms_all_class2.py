...
def calculate_mutation_score(subject_name, test_set_kind, mutated_model_path, predictions_path, op_list, mutantnum):
    ...
    t_killed_class_dict = os.path.join(predictions_path, subject_name, 'killed_class.csv')
    ...
    for mutant_name in mutant_list:
        ...
        if len(t_killed_class_dict[mutant_name])!=0:
            mutantnum += 1
...
if __name__ == '__main__':
    ...
    op_list = ['NS', 'NEB', 'GF', 'WS', 'NAI', 'LAa', 'DM'] # svhn
